...
public class PortalController {
    ...
    public PortalController(String mongoURIString) throws IOException {
        ...
        final MongoDatabase portalDatabase = mongoClient.getDatabase("carhunter");

        userDAO = new UserDAO(portalDatabase);
        sessionDAO = new SessionDAO(portalDatabase);
    ...
    private void initializeRoutes() throws IOException {
        ...
        post(new FreemarkerBasedRoute("/signup", "signup.html") {
            @Override
        ...
        // present signup form for portal
        get(new FreemarkerBasedRoute("/signup", "signup.html") {
            @Override
        ...
        get(new FreemarkerBasedRoute("/welcome", "welcome.html") {
            @Override
            protected void doHandle(Request request, Response response, Writer writer) throws IOException, TemplateException {
        ...
        get(new FreemarkerBasedRoute("/login", "login.html") {
            @Override
            protected void doHandle(Request request, Response response, Writer writer) throws IOException, TemplateException {
                SimpleHash root = new SimpleHash();
        ...
        post(new FreemarkerBasedRoute("/login", "login.html") {
            @Override
            protected void doHandle(Request request, Response response, Writer writer) throws IOException, TemplateException {
        ...
        get(new FreemarkerBasedRoute("/logout", "signup.html") {
            @Override
            protected void doHandle(Request request, Response response, Writer writer) throws IOException, TemplateException {
...
//        });
    ...
    private Configuration createFreemarkerConfiguration() {
        ...
        retVal.setClassForTemplateLoading(PortalController.class, "/");
        return retVal;
    }
